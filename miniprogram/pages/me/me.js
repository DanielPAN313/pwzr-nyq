...
const fallbackItems = [
  ...
  { label: "场馆合作", value: "联系中", target: "/pages/venue-admin/venue-admin" },
  { label: "支付与规则", value: "查看", target: "/pages/legal/legal" }
];
...
function buildItems(profile) {
  ...
  return [
    ...
    { label: "场馆合作", value: String(summary.pending_checkins || summary.checked_in || 0), target: "/pages/venue-admin/venue-admin" },
    { label: "支付与规则", value: "查看", target: "/pages/legal/legal" }
  ];
}
