...
function normalizeTeam(team) {
  ...
  return {
    ...
    homeVenue: team.homeVenue || team.home_venue_name || team.venue || team.area || "主场待定",
...
function normalizeGame(game) {
  ...
  return {
    ...
    venueName: game.venueName || game.venue_name || "场馆待定",
